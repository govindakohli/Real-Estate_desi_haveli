        ...
        <footer className="footer">
          <div className="footer-container">
            ...
            <div className="footer-column">
              <h4>Contact Us</h4>
              <p>
                <strong>Address:</strong> 123 Heritage Street, Old Town, India
              </p>
              <p>
            ...
            <div className="footer-column">
              ...
              <div className="social-icons">
                <a href="#" className="social-icon"><FaFacebookF />

                </a>
                <a href="#" className="social-icon"><BsTwitterX />
                </a>
                <a href="#" className="social-icon"><PiInstagramLogoFill />
                </a>
                <a href="#" className="social-icon"><FaLinkedinIn />
                </a>
              </div>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2024 DesiHaveli. All Rights Reserved.</p><br />
